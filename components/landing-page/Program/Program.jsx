...
const Program = () => {
  return (
    ...
    // nanti dihapus lagi divnya
    <div>

    </div>
    // <div className="bg-blue-900 py-20 px-10 text-white space-y-16">
    //   <h1 className="text-center text-3xl md:text-4xl font-bold font-nunito_sans">
    //     {/* Our Program */}
    //     PROGRAM KAMI
    //   </h1>
